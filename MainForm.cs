...
namespace Universul_Virtual
{
	...
	public partial class MainForm : Form
	{
		...
		void Label2Click(object sender, EventArgs e)
		{
			...
			frm.Show();
			frm.label1.Text = "Suntem o echipă de elevi din CNITV de clasa a XI a, pasionați de informatică și devotați acestui domeniu." + "\r\n" + "Apostol Andrei Laurențiu" + "\r\n" + "Medar Andrei" + "\r\n" + "Ghita Sebastian Cristian ";
		...
		void PictureBox6Click(object sender, EventArgs e)
		{
			...
			frm.richTextBox1.Text = text;
			frm.pictureBox1.Image = Image.FromFile("Resurse/Luna/Luna.jpg");
